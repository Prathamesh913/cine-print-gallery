...
function NotFoundComponent() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#000000] text-[#F5F5F5] px-4">
      <div className="max-w-md w-full rounded-2xl border border-white/15 bg-white/5 p-8 text-center shadow-2xl backdrop-blur-md">
        ...
        <p className="mt-4 text-sm text-white/65 leading-relaxed">
          We searched the projection room but couldn't find the reel you wanted. It might have been
          deleted, or left on the cutting room floor.
        </p>
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-[#000000] text-[#F5F5F5] px-4">
      <div className="max-w-md w-full rounded-2xl border border-white/15 bg-white/5 p-8 text-center shadow-2xl backdrop-blur-md">
        ...
        <p className="mt-4 text-sm text-white/65 leading-relaxed">
          Connection to the Notion database failed or the network went offline. Please check your
          internet connection, or retry the stream.
        </p>
        <div className="mt-8 flex flex-wrap justify-center gap-3">
          ...
          <a
            href="/"
            className="inline-flex items-center gap-2 rounded-full border border-white/15 bg-white/5 px-6 py-2.5 text-xs font-semibold text-[#F5F5F5] transition hover:bg-white/10"
          >
            <Home size={14} />
            BACK TO LOBBY
          </a>
    ...
    <html lang="en">
      <head>
        <meta
          ...
          content="uPz3YzMhSo1cbf5qS_wzNEUL2fEpV_AYp8nE-GB2gDE"
        />
        <HeadContent />
      </head>
      <body>
