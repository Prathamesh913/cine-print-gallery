...
export function Lightbox({ poster, posters = [], onNavigate, onClose }: Props) {
  ...
  const share = async () => {
    ...
    const data = {
      title: `${poster.title} — CinePrint`,
      text: `${poster.title} by ${poster.artist} on CinePrint!`,
      url,
    };
    if (navigator.share) {
      try {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`fixed inset-0 bg-black/60 transition-opacity duration-200 ease-[var(--ease-out)] md:hidden z-20 ${
      ...
      <button
        onClick={handleClose}
        aria-label="Close"
        className="fixed right-4 top-4 z-10 grid h-10 w-10 place-items-center rounded-full bg-white/10 text-[#F5F5F5] backdrop-blur transition-transform duration-150 ease-[var(--ease-out)] hoverable:hover:bg-white/20 active:scale-90"
      >
        <X size={20} />
      </button>
          ...
          <div className="relative flex items-start justify-center group/nav w-full">
            ...
            >
              <img
                ...
                onClick={() => setZoom((z) => !z)}
                className={`max-h-[calc(100vh-120px)] md:max-h-[85vh] w-full cursor-zoom-in rounded-lg object-contain transition-transform duration-200 ease-[var(--ease-out)] ${
              ...
              {!imageLoaded && (
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                  <div className="relative flex items-center justify-center">
                    ...
                    <FilmReelIcon
                      className="w-14 h-14 text-[#FF6B6B]/80 animate-spin"
          ...
          <div className="overflow-y-auto px-6 py-6 flex-grow md:overflow-visible md:px-0 md:py-0 flex flex-col gap-4">
                    ...
                    poster.artists.map((art, idx) => (
                      <span key={idx} className="inline-flex items-center flex-wrap">
                        ...
                        <Link
                          ...
                          preload="intent"
                          className="font-medium text-[#F5F5F5] underline underline-offset-4 hoverable:hover:text-[#FF6B6B] transition-colors duration-150"
                        >
                          {art.name}
                        </Link>
                      </span>
                    ...
                    {artistSocials.map((url, idx) => {
                      ...
                      return (
                        <a
                          ...
                          target="_blank"
                          rel="noreferrer"
                          className="inline-flex items-center gap-1 font-medium text-[#F5F5F5] underline underline-offset-4 hoverable:hover:text-[#FF6B6B] transition-colors duration-150"
                        >
                  ...
                  <div className="flex flex-wrap gap-2">
                    {poster.imdbId && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 rounded bg-[#F5C518]/10 border border-[#F5C518]/20 px-2 py-0.5 text-[10px] font-semibold text-[#F5C518] hoverable:hover:bg-[#F5C518]/20 active:scale-95 transition-[transform,background-color] duration-150 ease-[var(--ease-out)]"
                      >
                    ...
                    {poster.tmdbId && (
                      <a
                        ...
                        target="_blank"
                        rel="noreferrer"
                        className="inline-flex items-center gap-1.5 rounded bg-[#01B4E4]/10 border border-[#01B4E4]/20 px-2 py-0.5 text-[10px] font-semibold text-[#01B4E4] hoverable:hover:bg-[#01B4E4]/20 active:scale-95 transition-[transform,background-color] duration-150 ease-[var(--ease-out)]"
                      >
            ...
            {(!poster.artist ||
              ...
              <p className="text-[11px] leading-relaxed text-white/35">
                ...
                <Link
                  to="/about"
                  className="text-white/60 underline hoverable:hover:text-[#FF6B6B] transition-colors duration-150"
                >
                  About
                </Link>{" "}
